  ...
  <div class="row flex-nowrap">
    <div class="col-3 bd-sidebar">
      <ul class="nav">
     	  ...
     	  <br>
        <li><a href="MyPage.jsp">내 정보</a></li> <br>
        <li><a href="Mymodify.jsp">내 정보 변경</a></li> <br>
        <hr style="height: 1px; background-color: black;">
        <li><a href="Signout.jsp">회원 탈퇴</a></li> <br>
      </ul>
      <br>
    </div>
	...
	<div class="container"  style="background-color: #E8EAF8; height: 90vh;">
        ...
        <form class="needs-validation" novalidate="">
          ...
          <div class="row g-3">
            <div class="col-sm-6">
              <label for="Id" class='text'>Id</label> <br>
          ...
          <hr class="my-4">
					...
					<a class="w-100 btn btn-primary btn-lg" href="Mymodify.jsp"
					role="button">정보 변경하기</a>
        </form>
      </div>
	</div>
    </main>
