          ...
          <div class="card-body">
            ...
            <form name="form" class="form-signin" method="post" action="insertDB.jsp" onsubmit="return checkFun()">
               ...
               <div class="form-label-group">
                <input type="text" id="name" name="name" class="form-control" placeholder="Name" value="<jsp:getProperty property="name" name="user"/>" required autofocus>
              </div><br>
              <span style="color:red;"> 중복된 별명입니다. </span><br><br>
            
              <div class="form-label-group">
                <input type="text" id="id" name="id" class="form-control" placeholder="id" value="<jsp:getProperty property="id" name="user"/>" required>
              </div><br>
              
              <div class="form-label-group">
                <input type="password" id="password" name="password" class="form-control" placeholder="Password" value="<jsp:getProperty property="password" name="user"/>" required>
              </div><br>
              
              <div class="form-label-group">
                <input type="password" id="passwordCheck" name="passwordCheck" class="form-control" placeholder="PasswordCheck" value="<jsp:getProperty property="passwordCheck" name="user"/>" required>
              </div><br>
              
              <div class="form-label-group">
                <input type="email" id="email" name="email" class="form-control" placeholder="E-mail" value="<jsp:getProperty property="email" name="user"/>" required>
              </div><br>
