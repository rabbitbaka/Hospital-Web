          ...
          <div class="card-body">
            ...
            <form name="form" class="form-signin" method="post" action="insertDB.jsp" onsubmit="return checkFun()">
               ...
               <div class="form-label-group">
                <input type="name" id="name" name="name" class="form-control" placeholder="Name" value="<jsp:getProperty property="name" name="user"/>" required>
              </div><br>
            
              <div class="form-label-group">
                <input type="text" id="id" name="id" class="form-control" placeholder="id" required autofocus>
              </div><br>
              <span style="color:red;"> 중복된 아이디입니다. </span><br><br>
