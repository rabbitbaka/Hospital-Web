...
<body>
	...
	ResultSet rs = sm.executeQuery("SELECT name, id, passwd, email, signuptime FROM hospital.user");
					...
					<tr>
						<td>
							<button class="delete" type="button"
								onClick="location.href='user_delete.jsp?id=<%=rs.getString("id")%>'">탈퇴</button>
						</td>
						<td><%=count%></td>
