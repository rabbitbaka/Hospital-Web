...
<body>
	...
	<nav class="navbar navbar-expand-lg bg-body-tertiary"
		...
		<div class="container-fluid ">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				...
				<div id="top_menu">
					<% if (session.getAttribute("UserId") != null) { %>
					<a><%=(String) session.getAttribute("UserName")%>님 환영합니다!</a> | <a
						href="../Login/Logout.jsp">LOGOUT</a>
					<% } else { %>
	...
	<main role="main" class="container">
		<form name="form" action="post_modify_send.jsp" method="post"
			onsubmit="return checkFun()">
			<input type="hidden" name="num" value="<%=result.getInt("num") %>">
			<input type="hidden" name="writer"
				value="<%=result.getString("writer") %>">
			<div class="pt-1">
			...
			<div class="pt-1">
				<textarea id="summernote" name="contents"><%=result.getString("content") %></textarea>
			</div>
			<script>
			...
			<div class="pt-1 text-right">
				<button class="btn btn-primary btn-pull" type="submit">수정</button>
				<%
    ...
    %>
				<button class="btn btn-primary btn-pull" type="reset" onClick="location.href='post_modify.jsp?num=<%=result.getString("num")%>'">원상복구</button>
			</div>
		</form>
	</main>
	<%
