	...
	<nav class="navbar navbar-expand-lg bg-body-tertiary"
		...
		<div class="container-fluid ">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				...
				<div id="top_menu">
					<a href="Login.jsp" style="font-weight: bold;">LOGIN</a> | <a
						href="../Join/Join.jsp">JOIN</a>
				</div>
			</div>
		</div>
	</nav>
			...
			<div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
				<div class="card card-signin my-5">
					<div class="card-body">
						...
						<form name="form" action="findid_send.jsp" class="form-signin"
							method="post">
							...
							<button class="btn btn-lg btn-secondary btn-block text-uppercase"
								type="submit" style="width: 100%;">확인하기</button>
						</form>
						<br>
					</div>
